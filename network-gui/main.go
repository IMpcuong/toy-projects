...
// Entire implementation come from: https://gist.github.com/nathan-osman/18c2e227ad00a223b61c0b3c16d452c3 (win32.go).
...
func createWindow(className, windowName string, style uint32,
...
type tPOINT struct {
	//lint:ignore U1000 -> Reason: Using to specify each axis' position later.
	x, y int32
}
